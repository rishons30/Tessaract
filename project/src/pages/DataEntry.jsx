...
function DataEntry() {
  ...
  const [flightData, setFlightData] = useState({ flight_id: '', dep_time: '', arr_time: '' });
  const [aircraftData, setAircraftData] = useState({ tail_num: '', subtype: '', capacity: '' });
  ...
  const handleAircraftSubmit = (e) => {
    e.preventDefault();
    console.log('Aircraft added:', aircraftData);
  };
      ...
      <div className="forms-container">
        {activeForm === 'flight' ? (
          ...
          <AircraftForm
            ...
            handleAircraftSubmit={handleAircraftSubmit}
          />
        )}
      </div>
    </div>
